...
# Build the GUI
gladefile = "/usr/share/solydxk/softwaremanager/splash.glade"
...
splash_window.set_icon_from_file("/usr/share/solydxk/softwaremanager/data/templates/featured.svg")
...
template = open("/usr/share/solydxk/softwaremanager/data/templates/splash.html").read()
