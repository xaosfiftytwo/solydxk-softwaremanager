...
class Item:
    ...
    def __init__(self, portal, key, link="", solydxk_file="", category="", name="", description="", long_description="", added="", views="", license="", size="", website="", repository="", average_rating=""):
        self.portal=portal
        self.key=key
        self.link=link
        self.swm_file=solydxk_file
